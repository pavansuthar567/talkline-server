...
export default class UserController {
  ...
  static async getSingleUser(req: Request, res: Response) {
    try {
      ...
      const defaultResumeDetails = await ResumeService.getDefaultResumeByUserId(
        userId
      );
      console.log("defaultResumeDetails", defaultResumeDetails);

      const payload = {
        ...user.toObject?.(),
        resume: {
          resume_id: defaultResumeDetails?._id || "",
          title: defaultResumeDetails?.title || "",
          summary: defaultResumeDetails?.summary || "",
          skills: defaultResumeDetails?.skills || [],
          projects: defaultResumeDetails?.projects || [],
          education: defaultResumeDetails?.education || [],
          experience: defaultResumeDetails?.experience || [],
          certifications: defaultResumeDetails?.certifications || [],
        },
      };
